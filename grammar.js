...
module.exports = grammar({
  ...
  rules: {
    ...
    getter_definition: $ => seq($.name, alias($._labeled_block, $.block)),
    setter_definition: $ => seq($.name, "=", "(", $.parameter, ")", alias($._labeled_block, $.block)),
    ...
    method_definition: $ => seq($.name, "(", optional($.parameter_list), ")", alias($._labeled_block, $.block)),
